// src/components/product/CategoryDetailPage.tsx
...
export default async function CategoryDetailPage({ config, slug }: Props) {
  ...
  if (error || !data) {
    console.error(`Erreur chargement fiche ${config.slug}:`, error);
    notFound();
  }
    ...
    <main className="min-h-screen bg-[#F8F5F0]">
      <section className="mx-auto max-w-7xl px-5 pb-8 pt-28 sm:px-6 sm:pt-32 md:pb-12 lg:pb-16">
        ...
        >
          ...
          Retour aux {config.name.toLowerCase()}
        </Link>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.12fr_0.88fr] lg:items-start">
          <div>
            <ProductGallery
              ...
              badgeLabel={config.galleryBadgeLabel}
            />
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs leading-5 text-slate-600">
                    Nous vous aidons à choisir le {config.singular} adapté à
                    votre morphologie et à vos habitudes de sommeil.
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <section className="rounded-[2rem] bg-white p-6 shadow-sm sm:rounded-[2.5rem] sm:p-8 lg:p-10">
            ...
            <h2 className="mt-5 text-2xl font-bold text-[#103a63]">
              Pourquoi choisir ce {config.singular} ?
            </h2>
          ...
          <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr] md:items-center">
            <div>
              ...
              <h2 className="mt-2 text-xl font-bold leading-tight md:text-2xl">
                Vous hésitez entre plusieurs {config.name.toLowerCase()} ?
              </h2>
