...
export const metadata: Metadata = {
  ...
  description:
    "Signalez un défaut sur votre matelas KOALIT et transmettez une photo à notre équipe pour un traitement rapide.",
};
      ...
      <section className="mx-auto max-w-5xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-neutral-700">
            Un problème avec votre matelas ? Remplissez ce formulaire avec
            une photo du défaut constaté, notre équipe reviendra vers vous
            rapidement.
          </p>
        </div>

        <div className="mt-14 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="relative rounded-[2rem] bg-white p-8 shadow-sm">
          ...
          <aside className="h-fit rounded-[2rem] bg-[var(--koalit-blue)] p-8 text-white shadow-sm">
            ...
            <p className="mt-5 leading-7 text-white/80">
              Pour toute question avant d&apos;envoyer votre demande,
