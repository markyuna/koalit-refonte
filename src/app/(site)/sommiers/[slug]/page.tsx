...
export default async function SommierDetailPage({ params }: Props) {
  ...
  if (error || !data) {
    console.error("Erreur chargement fiche sommier:", error);
    notFound();
  }
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-600">
                    Nous vous aidons à choisir le sommier adapté à votre
                    matelas et à vos habitudes de sommeil.
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <section className="rounded-[2rem] bg-white p-6 shadow-sm sm:rounded-[2.5rem] sm:p-8 lg:p-10">
            ...
            <h2 className="mt-5 text-2xl font-bold text-[#103a63]">
              Pourquoi choisir ce sommier ?
            </h2>

            <div className="mt-7 space-y-5">
              {[
                "Un soutien pensé pour favoriser un meilleur alignement du corps.",
                "Une stabilité renforcée qui prolonge la durée de vie du matelas.",
                "Une sélection premium pour une expérience durable.",
                "Un accompagnement en magasin pour choisir le bon sommier.",
              ].map((item) => (
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold leading-tight md:text-4xl">
                Vous hésitez entre plusieurs sommiers ?
              </h2>
